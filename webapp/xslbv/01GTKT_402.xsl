...
<body>
<div style="width:700px; margin:0 auto; padding:8px; background-image: url('data:image/gif;base64,{inv:invoiceData/inv:userDefines/inv:Background}'); background-repeat:no-repeat; background-position:center; border:double #000;">
...
<table>
  ...
  <tr>
    <td colspan="3" align="left" valign="middle">Đơn vị bán hàng: <b><xsl:value-of select="translate(inv:invoiceData/inv:sellerLegalName,$lower,$upper)"/></b></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4" align="left" valign="middle">Đơn vị bán hàng: <b><xsl:value-of select="translate(inv:invoiceData/inv:sellerLegalName,$lower,$upper)"/></b></td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" valign="top">Mã số thuế: <xsl:value-of select="inv:invoiceData/inv:sellerTaxCode"/></td>
    <td align="left" valign="top">Điện thoại: <xsl:value-of select="inv:invoiceData/inv:sellerPhoneNumber"/></td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top">Họ tên người mua hàng: <xsl:value-of select="inv:invoiceData/inv:buyerDisplayName"/></td>
  ...
  <tr>
    <td align="left" valign="top">Mã số thuế: <xsl:value-of select="inv:invoiceData/inv:buyerTaxCode"/></td>
    <td align="left" valign="top">Điện thoại: <xsl:value-of select="inv:invoiceData/inv:buyerPhoneNumber"/></td>
...
<table>
  ...
  <col width="45%" />
  <tr>
    <td colspan="3" align="left">Số tiền bằng chữ:
      <xsl:choose>
  ...
  <tr>
    <td align="left" style="padding-left:20px;">Tổng tiền dịch vụ, hàng hóa không chịu thuế:</td>
    <td align="left">
      <xsl:for-each select="inv:invoiceData/inv:invoiceTaxBreakdowns/inv:invoiceTaxBreakdown">
      <xsl:choose>
        <xsl:when test="(inv:vatPercentage) and (inv:vatPercentage)!='' and (inv:vatPercentage)=-1"><xsl:value-of select="format-number(inv:vatTaxableAmount+inv:vatTaxAmount, '#.###', 'vndong')"/></xsl:when>
        <xsl:otherwise>&nbsp;</xsl:otherwise>
      </xsl:choose>
      </xsl:for-each>
    </td>
  ...
  <tr>
    <td align="left" style="padding-left:20px;">Tổng tiền dịch vụ, hàng hóa thuế suất 0%:</td>
    <td align="left">
      <xsl:for-each select="inv:invoiceData/inv:invoiceTaxBreakdowns/inv:invoiceTaxBreakdown">
      <xsl:choose>
        <xsl:when test="(inv:vatPercentage) and (inv:vatPercentage)!='' and (inv:vatPercentage)=0"><xsl:value-of select="format-number(inv:vatTaxableAmount+inv:vatTaxAmount, '#.###', 'vndong')"/></xsl:when>
        <xsl:otherwise>&nbsp;</xsl:otherwise>
      </xsl:choose>
      </xsl:for-each>
    </td>
  ...
  <tr>
    <td align="left" style="padding-left:20px;">Tổng tiền dịch vụ, hàng hóa thuế suất 5%:</td>
    <td align="left">
      <xsl:for-each select="inv:invoiceData/inv:invoiceTaxBreakdowns/inv:invoiceTaxBreakdown">
      <xsl:choose>
        <xsl:when test="(inv:vatPercentage) and (inv:vatPercentage)!='' and (inv:vatPercentage)=5"><xsl:value-of select="format-number(inv:vatTaxableAmount+inv:vatTaxAmount, '#.###', 'vndong')"/></xsl:when>
        <xsl:otherwise>&nbsp;</xsl:otherwise>
      </xsl:choose>
      </xsl:for-each>
    </td>
  ...
  <tr>
    <td align="left" style="padding-left:20px;">Tổng tiền dịch vụ, hàng hóa thuế suất 10%:</td>
    <td align="left">
      <xsl:for-each select="inv:invoiceData/inv:invoiceTaxBreakdowns/inv:invoiceTaxBreakdown">
      <xsl:choose>
        <xsl:when test="(inv:vatPercentage) and (inv:vatPercentage)!='' and (inv:vatPercentage)=10"><xsl:value-of select="format-number(inv:vatTaxableAmount+inv:vatTaxAmount, '#.###', 'vndong')"/></xsl:when>
        <xsl:otherwise>&nbsp;</xsl:otherwise>
      </xsl:choose>
      </xsl:for-each>
    </td>
  ...
  <tr>
    <td align="left" style="padding-left:20px;">Tổng tiền khách hàng phải trả:</td>
    <td align="left">
      <xsl:choose>
...
<table cellspacing="0" cellpadding="2" style="color:BLACK; table-layout:fixed; margin-top:5px; font-size:8pt;">
  ...
  <tr>
    ...
    <td align="right" class="borderTD">
      <xsl:choose>
        <xsl:when test="(inv:unitPrice) and (inv:unitPrice)!='' and (inv:unitPrice)!=0"><xsl:value-of select="format-number(inv:unitPrice, '#.###', 'vndong')"/></xsl:when>
        <xsl:otherwise>&nbsp;</xsl:otherwise>
      </xsl:choose>
    </td>
    <td align="right" class="borderTD">
      <xsl:choose>
        <xsl:when test="(inv:itemTotalAmountWithoutVat) and (inv:itemTotalAmountWithoutVat)!='' and (inv:itemTotalAmountWithoutVat)!=0"><xsl:value-of select="format-number(inv:itemTotalAmountWithoutVat, '#.###', 'vndong')"/></xsl:when>
        <xsl:otherwise>&nbsp;</xsl:otherwise>
      </xsl:choose>
    </td>
    <td align="center" class="borderTD">
    ...
    <td align="right" class="borderTD">
      <xsl:choose>
        <xsl:when test="(inv:vatAmount) and (inv:vatAmount)!='' and (inv:vatAmount)!=0"><xsl:value-of select="format-number(inv:vatAmount, '#.###', 'vndong')"/></xsl:when>
        <xsl:otherwise>&nbsp;</xsl:otherwise>
      </xsl:choose>
    </td>
    <td align="right" class="borderTD">
      <xsl:choose>
        <xsl:when test="(inv:itemTotalAmountWithoutVat) and (inv:itemTotalAmountWithoutVat)!=''"><xsl:value-of select="format-number((inv:vatAmount+inv:itemTotalAmountWithoutVat), '#.###', 'vndong')"/></xsl:when>
        <xsl:otherwise>&nbsp;</xsl:otherwise>
      </xsl:choose>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td align="right" class="borderTD">
      <xsl:choose>
        <xsl:when test="(inv:invoiceData/inv:totalVATAmount) and (inv:invoiceData/inv:totalVATAmount)!='' and (inv:invoiceData/inv:totalVATAmount)!=0"><xsl:value-of select="format-number(inv:invoiceData/inv:totalVATAmount, '#.###', 'vndong')"/></xsl:when>
        <xsl:otherwise>&nbsp;</xsl:otherwise>
      </xsl:choose>
    </td>
    <td align="right" class="borderTD">
