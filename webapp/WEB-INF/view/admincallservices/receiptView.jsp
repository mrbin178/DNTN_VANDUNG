...
<div class="ts24-window-content">
	<div class="contenttable">
		<h2 class="search">Tra cứu phiếu thu điện tử</h2>
		<form id="searchHDDTForm" name="searchHDDTForm">
			<table width="100%" cellspacing="0" cellpadding="3" border="0"
				...
				<tbody>
					...
					<tr>
						<td valign="middle" align="right" class="input_form">Mã tra cứu:</td>
						<td valign="middle"><input class="textinput" type="text"
							name="maTraCuu" id="maTraCuu" style="width: 150px;" /></td>
						<td></td>
						<td></td>
					</tr>
					<tr>
	...
	<c:if test="${not empty listRecords && listRecords !='' }">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tbl_style_blue txt_small" >
			<tr>
				...
				<th width="15%" align="left">Số phiếu thu</th>
				<th width="15%" align="left">Ngày xuất phiếu thu</th>
			</tr>
...
<script type="text/javascript">
	function viewInvoiceDetail(id, loaiHDon){
		window.open("${HOADON_DIENTU_CONTEXT_PATH}/detailPhieuThuTS24ID.bv?id="+ id+ "&loaiHD="+ loaiHDon,'_blank',
		...
		$(idTable).jtable({
			...
			actions : {
				listAction : function(postData, jtParams) {
					...
					return $.Deferred(function($dfd) {
						$.ajax({
							url : '${ADMIN_CALL_SERVICES_CONTEXT_PATH}/receiptTS24ID.bv?jtStartIndex='
			...
			fields : {
				...
				SoHoaDon : {
					...
					title : 'Số phiếu thu',
					display : function(data) {
						var $linkSHD = $('<a href="#" title="Xem phiếu thu">'
								+ data.record.SoHoaDon + '</a>');
						$linkSHD
								.click(function() {
									window
											.open(
													"${ADMIN_CALL_SERVICES_CONTEXT_PATH}/viewReceiptDialog.bv?id="
															+ data.record.ID
															+ "&loaiHD="
