...
<script type="text/javascript" charset="utf-8">
	...
	function viewxml(_id) {
		...
		document.forms["searchInvoiceForm"].action = '${SEARCHINVOICE_CONTEXT_PATH}/view_certified_invioce_apply.bv';
		document.forms["searchInvoiceForm"].submit();
	}
...
<c:set var="ADMIN_CALL_SERVICES_CONTEXT_PATH" value="${pageContext.request.contextPath}/admincallservices" scope="session"/>
<c:set var="SEARCH_RECEIPT_CONTEXT_PATH" value="${pageContext.request.contextPath}/receipt" scope="session"/>
...
<body onload="beginLoadForm()">
	...
	<form:form action="" commandName="searchInvoiceForm"
		...
		<input type="hidden" value="1" name="apply" id="apply" />
	</form:form>
