		...
		<spring:form commandName="createLockMstForm" id="createLockMstForm" name="createLockMstForm"
			...
			<table width="100%" cellspacing="0" cellpadding="3" border="0" class="txt_1">
				<tbody>
					...
					<tr>
						<td width="35%" align="right" class="input_form"><label
							style="margin: 10px 0px 20px 2px"> Mã số thuế<span
								class="requiredfield">*</span>:
						</label></td>
						<td width="25%">
							<spring:input path="mst" id="mst" type="text" name="mst" style="width:200px" maxlength="255" />
						</td>
						<td ><spring:errors path="mst"
								cssClass="error" /></td>
					</tr>
					
					<tr>
						<td width="25%" valign="middle" align="right" class="input_form">Ngày bắt đầu<span class="requiredfield">*</span>: </td>
					...
					<tr>
						<td width="15%" valign="middle" align="right" class="input_form">Ngày kết thúc: </td>
					...
					<tr valign="middle">
						<td></td>
						<td valign="middle">
							<input class="formButton" value="Tạo" type="submit"> 
