    ...
    <table>
      ...
      <tr>
        ...
        <td rowspan="4" align="right" valign="middle" style="z-index:-1; margin-right:5px;">
          <xsl:choose>
            <xsl:when test="(/Invoice/qrCodeData) and (/Invoice/qrCodeData!='')"><img style="max-width:90px; max-height:90px; float:right; right:5px;" src='data:image/png;base64,{/Invoice/qrCodeData}' /></xsl:when>
            <xsl:otherwise>&nbsp;</xsl:otherwise>
          </xsl:choose>
        </td>
      </tr>
    ...
    <table style="table-layout:auto">
      ...
      <tr>
        ...
        <td align="center" valign="middle" style="white-space:nowrap; color:#000;">
          ...
          -->
          <div style="position:relative; z-index:1; font-size:9pt;">
          <div style="height:72px; background-image: url('data:image/png;base64,{/Invoice/imageTVAN/@URI}'); background-repeat:no-repeat; background-position:center center; top:-10px; bottom:0; right:0; left:0; opacity:0.7; filter: alpha(opacity=70);"></div>
          <br />
        ...
        <td align="center" valign="middle" style="white-space:nowrap; color:#000;">
          ...
          <div style="position:relative; z-index:1; font-size:9pt;">
          <div style="height:72px; background-image: url('data:image/png;base64,{/Invoice/image/@URI}'); background-repeat:no-repeat; background-position:center center; top:-10px; bottom:0; right:0; left:0; opacity:0.7; filter: alpha(opacity=70);"></div>
          <br />
