<?xml version="1.0" encoding="utf-8"?><!-- DWXMLSource="01GTKT0001KR16E_0309478306999_0000077.xml" -->
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:inv="http://laphoadon.gdt.gov.vn/2014/09/invoicexml/v1">
          ...
          <xsl:when test="(TvanData/Content/InvoiceNo) and (TvanData/Content/InvoiceNo)='0000000'">
            ...
            <table cellspacing="0" cellpadding="2" style="color:BLACK; table-layout:fixed;">
              ...
              <tr>
                ...
                <td align="center" class="borderTD">Chiết khấu</td>
              ...
              <tr><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td></tr>
              <tr>
                <td colspan="6" align="right" class="borderTD"><b>Tổng cộng:</b></td>
          ...
          <xsl:when test="(TvanData/Content/Extra/SoBangKe) and (TvanData/Content/Extra/SoBangKe)!='' and (TvanData/Content/Extra/SoBangKe)!=0">
            ...
            <table cellspacing="0" cellpadding="2" style="color:BLACK; table-layout:fixed;">
              ...
              <tr>
                ...
                <td align="right" class="borderTD">
                  <xsl:choose>
                    <xsl:when test="(TvanData/Content/Discount_Amount) and (TvanData/Content/Discount_Amount)!=''"><xsl:value-of select="format-number(TvanData/Content/Discount_Amount, '#.##0,##', 'vndong')"/></xsl:when>
                    <xsl:otherwise>&nbsp;</xsl:otherwise>
                  </xsl:choose>
                </td>
                <td align="right" class="borderTD">
              ...
              <tr><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td></tr>
              <tr>
                <td align="right" colspan="6" class="borderTD"><b>Tổng cộng:</b></td>
                <td align="right" class="borderTD">
                  <xsl:choose>
                    <xsl:when test="(TvanData/Content/VAT_Amount) and (TvanData/Content/VAT_Amount)!=''"><xsl:value-of select="format-number(TvanData/Content/VAT_Amount, '#.##0,##', 'vndong')"/></xsl:when>
                    <xsl:otherwise>&nbsp;</xsl:otherwise>
          ...
          <xsl:otherwise>
            ...
            <table cellspacing="0" cellpadding="2" style="color:BLACK; table-layout:fixed;">
              ...
              <tr>
                ...
                <td align="right" class="borderTD">
                  <xsl:choose>
                    <xsl:when test="(DiscountAmount) and (DiscountAmount)!='' and (DiscountAmount)!=0"><xsl:value-of select="format-number(DiscountAmount, '#.##0,##', 'vndong')"/></xsl:when>
                    <xsl:otherwise>&nbsp;</xsl:otherwise>
                  </xsl:choose>
                </td>
                <td align="right" class="borderTD">
  ...
  <xsl:variable name="TTNguoiBanvaNguoiMua">
    ...
    <table>
      ...
      <tr>
        <td colspan="2" align="left" valign="top" style="border-top:1px solid #000">Họ tên khách hàng: <xsl:value-of select="/Invoice/TvanData/Content/CusName"/></td>
  ...
  <xsl:variable name="CKS">
    <table style="table-layout:auto">
      ...
      <tr>
        ...
        <td align="center" valign="bottom">
          <xsl:choose>
            <xsl:when test="(/Invoice/TvanData/Content/SignDate) and (/Invoice/TvanData/Content/SignDate)!='' and substring(/Invoice/TvanData/Content/SignDate,5,1)='-'"><i>Ngày <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,9,2)" /> tháng <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,6,2)" /> năm <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,1,4)" /></i></xsl:when>
            <xsl:when test="(/Invoice/TvanData/Content/SignDate) and (/Invoice/TvanData/Content/SignDate)!='' and substring(/Invoice/TvanData/Content/SignDate,3,1)='/'"><i>Ngày <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,1,2)" /> tháng <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,4,2)" /> năm <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,7,4)" /></i></xsl:when>
  ...
  <xsl:variable name="GhiChu">
    <table style="color:BLACK">
      <xsl:if test="/Invoice/TvanData/Content/Extra/HoaDonThayThe">
      <tr>
