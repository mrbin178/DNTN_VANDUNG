<?xml version="1.0" encoding="utf-8"?><!-- DWXMLSource="HDDT_GTGT_Elite_M7.xml" -->
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:inv="http://laphoadon.gdt.gov.vn/2014/09/invoicexml/v1">
  ...
  <xsl:variable name="TTXacThucvaTTGiaoDich">
    <table>
      ...
      <tr>
        <td align="left" valign="top" style="border-bottom:1px solid #0a51a1">Số tài khoản <i>(Account No.)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:sellerBankAccount"/></td>
        <td colspan="3" align="left" valign="top" style="border-bottom:1px solid #0a51a1">Tại ngân hàng <i>(At)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:sellerBankName"/></td>
      </tr>
      <xsl:choose>
      ...
      <tr>
        <td colspan="4" align="left" valign="top">Số hợp đồng/Vận đơn <i>(Contract/Bill of lading No.)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:userDefines/inv:Logistic"/></td>
      </tr>
      <tr>
