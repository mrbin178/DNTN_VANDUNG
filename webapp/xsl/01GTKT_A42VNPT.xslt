...
<!-- DWXMLSource="01_GTGT_DT_VNPT_v1.0.2.xml" -->
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:inv="http://laphoadon.gdt.gov.vn/2014/09/invoicexml/v1">
							...
							<table cellspacing="0" cellpadding="2" style="color:BLACK; table-layout:fixed;">
								...
								<tr>
									...
									<td align="left" class="borderTD">
										<xsl:choose>
											<xsl:when test="(TvanData/Content/Extra/ThongTinHangChung) and (TvanData/Content/Extra/ThongTinHangChung)!=''">
												<xsl:value-of select="TvanData/Content/Extra/ThongTinHangChung"/>
											</xsl:when>
									...
									<td align="right" class="borderTD">
										<xsl:choose>
											<xsl:when test="(TvanData/Content/Total) and (TvanData/Content/Total)!=''">
												<xsl:value-of select="format-number(TvanData/Content/Total, '#.##0,##', 'vndong')"/>
											</xsl:when>
											<xsl:otherwise>&nbsp;</xsl:otherwise>
										</xsl:choose>
									</td>
									...
									<td align="right" class="borderTD">
										<xsl:choose>
											<xsl:when test="(TvanData/Content/VAT_Amount) and (TvanData/Content/VATAmount)!=''">
												<xsl:value-of select="format-number(TvanData/Content/VATAmount, '#.##0,##', 'vndong')"/>
											</xsl:when>
											<xsl:otherwise>&nbsp;</xsl:otherwise>
										</xsl:choose>
									</td>
									<td align="right" class="borderTD">
										<xsl:choose>
											<xsl:when test="(TvanData/Content/Amount) and (TvanData/Content/Amount)!=''">
												<xsl:value-of select="format-number(TvanData/Content/Amount, '#.##0,##', 'vndong')"/>
											</xsl:when>
											<xsl:otherwise>&nbsp;</xsl:otherwise>
										</xsl:choose>
									</td>
								...
								<tr>
									<td align="right" colspan="5" class="borderTD">
										<b>Tổng cộng:</b>
									</td>
									<td align="right" class="borderTD">
										<b>
									...
									<td align="right" class="borderTD">
										<b>
											<xsl:choose>
												<xsl:when test="(TvanData/Content/VAT_Amount) and (TvanData/Content/VAT_Amount)!=''">
													<xsl:value-of select="format-number(TvanData/Content/VAT_Amount, '#.##0,##', 'vndong')"/>
												</xsl:when>
												<xsl:otherwise>&nbsp;</xsl:otherwise>
											</xsl:choose>
										</b>
							...
							<table cellspacing="0" cellpadding="2" style="color:BLACK; table-layout:fixed;">
								...
								<xsl:for-each select="TvanData/Content/Products/Product">
									<tr>
										...
										<td align="left" class="borderTD">
											<xsl:choose>
												<xsl:when test="(ProdName) and (ProdName)!=''">
										...
										<td align="center" class="borderTD">
											<xsl:choose>
												<xsl:when test="(ProdUnit) and (ProdUnit)!=''">
										...
										<td align="right" class="borderTD">
											<xsl:choose>
												<xsl:when test="(ProdQuantity) and (ProdQuantity)!='' and (ProdQuantity)!=0">
													<xsl:value-of select="format-number(ProdQuantity, '#.##0,####', 'vndong')"/>
												</xsl:when>
												<xsl:otherwise>&nbsp;</xsl:otherwise>
											</xsl:choose>
										</td>
										<td align="right" class="borderTD">
											<xsl:choose>
												<xsl:when test="(ProdPrice) and (ProdPrice)!='' and (ProdPrice)!=0">
													<xsl:value-of select="format-number(ProdPrice, '#.##0,##', 'vndong')"/>
												</xsl:when>
												<xsl:otherwise>&nbsp;</xsl:otherwise>
											</xsl:choose>
										</td>
										<td align="right" class="borderTD">
											<xsl:choose>
												<xsl:when test="(Total) and (Total)!='' and (Total)!=0">
													<xsl:value-of select="format-number(Total, '#.##0,##', 'vndong')"/>
												</xsl:when>
												<xsl:otherwise>&nbsp;</xsl:otherwise>
											</xsl:choose>
										</td>
										<td align="center" class="borderTD">
											<xsl:choose>
												<xsl:when test="(VATRate) and (VATRate)!='' and (VATRate)!=-1 and (VATRate)!=-2">
													<xsl:value-of select="format-number(VATRate, '#.##0,###', 'vndong')"/>
												</xsl:when>
										...
										<td align="right" class="borderTD">
											<xsl:choose>
												<xsl:when test="(VATAmount) and (VATAmount)!='' and (VATAmount)!=0">
													<xsl:value-of select="format-number(VATAmount, '#.##0,##', 'vndong')"/>
												</xsl:when>
												<xsl:otherwise>&nbsp;</xsl:otherwise>
											</xsl:choose>
										</td>
										<td align="right" class="borderTD">
											<xsl:choose>
												<xsl:when test="(Amount) and (Amount)!='' and (Amount)!=0">
													<xsl:value-of select="format-number(Amount, '#.##0,##', 'vndong')"/>
												</xsl:when>
												<xsl:otherwise>&nbsp;</xsl:otherwise>
											</xsl:choose>
										</td>
		...
		<table style="table-layout:auto">
			...
			<tr>
				<td align="center" valign="middle" style="max-width:200px; max-height:150px">
					<xsl:choose>
						<xsl:when test="(/Invoice/TvanData/Content/Extra/Logo) and (/Invoice/TvanData/Content/Extra/Logo!='')">
							<img src='data:image/png;base64,{/Invoice/TvanData/Content/Extra/Logo}'/>
						</xsl:when>
						<xsl:otherwise>&nbsp;</xsl:otherwise>
					</xsl:choose>
				</td>
          ...
          Mẫu số: <xsl:value-of select="/Invoice/TvanData/Content/InvoicePattern"/>
					<br/>
          Ký hiệu: <xsl:value-of select="/Invoice/TvanData/Content/SerialNo"/>
					<br/>
          Số: <span style="font-size:15pt">
						<b>
							<xsl:value-of select="/Invoice/TvanData/Content/InvoiceNo"/>
						</b>
					</span>
				</td>
			</tr>
		...
		<table>
			...
			<tr>
				<td colspan="3" align="left" valign="middle">
					<b>
						<xsl:value-of select="translate(/Invoice/TvanData/Content/ComName,$lower,$upper)"/>
					</b>
				</td>
				<td rowspan="4" align="right" valign="middle" style="z-index:-1; margin-right:5px;">
					<xsl:choose>
						<xsl:when test="(/Invoice/qrCodeData) and (/Invoice/qrCodeData!='')">
							<img style="max-width:90px; max-height:90px; float:right; right:5px;" src='data:image/png;base64,{/Invoice/qrCodeData}'/>
						</xsl:when>
						<xsl:otherwise>&nbsp;</xsl:otherwise>
					</xsl:choose>
				</td>
			...
			<tr>
				<td colspan="3" align="left" valign="top">Địa chỉ: <xsl:value-of select="/Invoice/TvanData/Content/ComAddress"/>
				</td>
			</tr>
			<tr>
				<td align="left" valign="top">MST: <xsl:value-of select="/Invoice/TvanData/Content/ComTaxCode"/>
				</td>
				<td align="left" valign="top">Tel: <xsl:value-of select="/Invoice/TvanData/Content/ComPhone"/>
				</td>
				<td align="left" valign="top">Email: <xsl:value-of select="/Invoice/TvanData/Content/Extra/EmailNguoiBan"/>
				</td>
			</tr>
			<tr>
				<td align="left" valign="top">Số tài khoản: <xsl:value-of select="/Invoice/TvanData/Content/ComBankNo"/>
				</td>
				<td colspan="2" align="left" valign="top">Tại ngân hàng: <xsl:value-of select="/Invoice/TvanData/Content/ComBankName"/>
				</td>
			</tr>
		</table>
		<table>
			...
			<xsl:choose>
				<xsl:when test="(/Invoice/TvanData/Content/Extra/MauIn) and (/Invoice/TvanData/Content/Extra/MauIn!='') and (substring-after(/Invoice/TvanData/Content/Extra/MauIn,'_')='41VNPT')">
					<tr>
						<td colspan="2" align="left" valign="top" style="border-top:1px solid #000">Họ tên khách hàng: <xsl:value-of select="/Invoice/TvanData/Content/CusName"/>
						</td>
						<td colspan="2" align="left" valign="top" style="border-top:1px solid #000">Mã nhận hóa đơn: <xsl:value-of select="/Invoice/TvanData/Content/Extra/MaNhanHoaDon"/>
						</td>
					</tr>
				</xsl:when>
				<xsl:otherwise>
					<tr>
						<td colspan="4" align="left" valign="top" style="border-top:1px solid #000">Họ tên khách hàng: <xsl:value-of select="/Invoice/TvanData/Content/Buyer"/>
						</td>
					</tr>
				</xsl:otherwise>
			</xsl:choose>
			<tr>
				<td colspan="4" align="left" valign="top">Tên đơn vị: <xsl:value-of select="/Invoice/TvanData/Content/CusName"/>
				</td>
			</tr>
			<tr>
				<td colspan="4" align="left" valign="top">Địa chỉ: <xsl:value-of select="/Invoice/TvanData/Content/CusAddress"/>
				</td>
			</tr>
			<tr>
				<td align="left" valign="top">MST: <xsl:value-of select="/Invoice/TvanData/Content/CusTaxCode"/>
				</td>
				<td align="left" valign="top">Tel: <xsl:value-of select="/Invoice/TvanData/Content/CusPhone"/>
				</td>
				<td colspan="2" align="left" valign="top">Email: <xsl:value-of select="/Invoice/TvanData/Content/Extra/EmailNguoiMua"/>
				</td>
			</tr>
			<tr>
				<td align="left" valign="top">Số tài khoản: <xsl:value-of select="/Invoice/TvanData/Content/CusBankNo"/>
				</td>
				<td colspan="3" align="left" valign="top">Tại ngân hàng: <xsl:value-of select="/Invoice/TvanData/Content/CusBankName"/>
				</td>
			</tr>
			<tr>
				<td colspan="2" align="left" valign="top">Hình thức thanh toán: <xsl:value-of select="/Invoice/TvanData/Content/Kind_of_Payment"/>
				</td>
				<td colspan="2" align="left" valign="top">Loại tiền: <xsl:value-of select="/Invoice/TvanData/Content/Extra/currencyCode"/>
				</td>
			</tr>
		</table>
	</xsl:variable>
	...
	<xsl:variable name="SoTienBangChu">
		<table>
          ...
          <xsl:choose>
						<xsl:when test="/Invoice/TvanData/Content/Amount_words!=''">
							<xsl:value-of select="/Invoice/TvanData/Content/Amount_words"/>
						</xsl:when>
						<xsl:otherwise>&nbsp;</xsl:otherwise>
					</xsl:choose>
				</td>
		...
		<table style="table-layout:auto">
          ...
          Người mua hàng
				...
				<td align="left" valign="middle">
					<xsl:choose>
						<xsl:when test="(/Invoice/TvanData/Content/Extra/NguoiChuyenDoi) and (/Invoice/TvanData/Content/Extra/NguoiChuyenDoi)!=''">Người chuyển đổi: <xsl:value-of select="/Invoice/TvanData/Content/Extra/NguoiChuyenDoi"/>
						</xsl:when>
						<xsl:otherwise>
							<span id="nguoiCD"/>
						</xsl:otherwise>
				...
				<td align="center" valign="bottom">
					<xsl:choose>
						<xsl:when test="(/Invoice/TvanData/Content/SignDate) and (/Invoice/TvanData/Content/SignDate)!='' and substring(/Invoice/TvanData/Content/SignDate,5,1)='-'">
							<i>Ngày <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,9,2)"/> tháng <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,6,2)"/> năm <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,1,4)"/>
							</i>
						</xsl:when>
						<xsl:when test="(/Invoice/TvanData/Content/SignDate) and (/Invoice/TvanData/Content/SignDate)!='' and substring(/Invoice/TvanData/Content/SignDate,3,1)='/'">
							<i>Ngày <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,1,2)"/> tháng <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,4,2)"/> năm <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,7,4)"/>
							</i>
						</xsl:when>
						<xsl:otherwise>
							<i>Ngày <span style="margin-left:10px">&nbsp;</span> tháng <span style="margin-left:10px">&nbsp;</span> năm <span style="margin-left:30px">&nbsp;</span>
							</i>
						</xsl:otherwise>
					</xsl:choose>
					<br/>
          ...
          -->
							<div style="position:relative; z-index:1; font-size:9pt;">
								<div style="height:72px; background-image: url('data:image/png;base64,{/Invoice/imageTVAN/@URI}'); background-repeat:no-repeat; background-position:center center; top:-10px; bottom:0; right:0; left:0; opacity:0.7; filter: alpha(opacity=70);"/>
								<br/>
          Tình trạng chữ ký: <xsl:value-of select="/Invoice/imageTVAN"/>
								<br/>
          ...
          Ký ngày: <xsl:value-of select="/Invoice/TvanData/Date"/>
					...
					<td align="center" valign="middle" style="white-space:nowrap; color:#000;">
						<xsl:if test="((/Invoice/image) and (/Invoice/image)!='')">
							<div style="position:relative; z-index:1; font-size:9pt;">
								<div style="height:72px; background-image: url('data:image/png;base64,{/Invoice/image/@URI}'); background-repeat:no-repeat; background-position:center center; top:-10px; bottom:0; right:0; left:0; opacity:0.7; filter: alpha(opacity=70);"/>
								<br/>
          Tình trạng chữ ký: <xsl:value-of select="/Invoice/image"/>
								<br/>
          Ký bởi: <xsl:value-of select="/Invoice/CNCom"/>
								<br/>
			...
			<xsl:if test="(/Invoice/TvanData/Content/Extra/HoaDonThayThe) and (/Invoice/TvanData/Content/Extra/HoaDonThayThe!=7)">
				<tr>
					<td style="font-size:9pt; text-align:center;">
						<xsl:value-of select="/Invoice/TvanData/Content/Extra/HoaDonThayThe"/>
					</td>
				</tr>
			</xsl:if>
			<tr>
		...
		<table>
			...
			<tr>
				<td colspan="3" align="center" valign="middle">
					<span style="font-size:16pt">
						<b>BẢNG KÊ CHI TIẾT HÀNG HÓA, DỊCH VỤ</b>
					</span>
					<br/>
					<i>
          (Kèm theo hóa đơn số <span style="font-size:13pt">
							<b>
								<xsl:value-of select="/Invoice/TvanData/Content/InvoiceNo"/>
							</b>&nbsp;</span>
						<xsl:choose>
							<xsl:when test="(/Invoice/TvanData/Content/SignDate) and (/Invoice/TvanData/Content/SignDate)!='' and substring(/Invoice/TvanData/Content/SignDate,5,1)='-'">ngày <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,9,2)"/> tháng <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,6,2)"/> năm <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,1,4)"/>)</xsl:when>
							<xsl:when test="(/Invoice/TvanData/Content/SignDate) and (/Invoice/TvanData/Content/SignDate)!='' and substring(/Invoice/TvanData/Content/SignDate,3,1)='/'">ngày <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,1,2)"/> tháng <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,4,2)"/> năm <xsl:value-of select="substring(/Invoice/TvanData/Content/SignDate,7,4)"/>)</xsl:when>
