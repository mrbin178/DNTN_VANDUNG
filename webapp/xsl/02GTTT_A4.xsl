...
<table>
  ...
  <xsl:choose>
    <xsl:when test="(inv:invoiceData/inv:userDefines/inv:MauIn) and (inv:invoiceData/inv:userDefines/inv:MauIn!='') and (substring-after(inv:invoiceData/inv:userDefines/inv:MauIn,'_')='41')">
  <tr>
    ...
    <xsl:otherwise>
  <tr>
    <td colspan="4" align="left" valign="top">Họ tên khách hàng: <xsl:value-of select="inv:invoiceData/inv:buyerDisplayName"/></td>
  </tr>
    </xsl:otherwise>
  </xsl:choose>
  <tr>
...
<table cellspacing="0" cellpadding="2" style="color:BLACK; table-layout:fixed;">
  ...
  <tr><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td></tr>
  <tr>
    <td align="right" colspan="5" class="borderTD" style="padding-right:2%"><b>Tổng tiền hàng hóa, dịch vụ</b></td>
