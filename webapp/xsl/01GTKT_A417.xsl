<?xml version="1.0" encoding="utf-8"?><!-- DWXMLSource="HDDT_GTGT_M11.xml" -->
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:inv="http://laphoadon.gdt.gov.vn/2014/09/invoicexml/v1">
  ...
  <xsl:template match="inv:invoice">
    <html>
      <head>
        ...
        <style type="text/css">
          table { empty-cells:show; border: 0; width: 700px; font-size:10pt; font-family:"Times New Roman", Times, serif; color:#0a51a1; border-collapse:collapse; table-layout:fixed; position:relative; }
          ...
          .borderTD_detail { border:1px solid #0a51a1; border-collapse:collapse; vertical-align:middle; word-break: break-all; }
      ...
      <body>
        ...
        -->
      <div style="width:700px; margin:0 auto; padding:8px; background-image: url('data:image/png;base64,{/inv:invoice/inv:invoiceData/inv:userDefines/inv:Background}'); background-repeat:no-repeat; background-position:center center; text-align: center center;">
        <!-- Hình hóa đơn mẫu -->
        ...
        <xsl:choose>
          ...
          <xsl:when test="(/inv:invoice/inv:invoiceData/inv:invoiceNumber) and (/inv:invoice/inv:invoiceData/inv:invoiceNumber)='0000000'">
          ...
          <xsl:when test="(inv:invoiceData/inv:userDefines/inv:SoBangKe) and (inv:invoiceData/inv:userDefines/inv:SoBangKe)!='' and (inv:invoiceData/inv:userDefines/inv:SoBangKe)!=0">
            <table cellspacing="0" cellpadding="2" style="table-layout:fixed;">
              ...
              <xsl:choose>
                <xsl:when test="not(/inv:invoice/inv:invoiceData/inv:currencyCode) or (/inv:invoice/inv:invoiceData/inv:currencyCode)='' or translate(/inv:invoice/inv:invoiceData/inv:currencyCode,$lower,$upper)='VND' or translate(/inv:invoice/inv:invoiceData/inv:currencyCode,$lower,$upper)='VNĐ'">
                  <tr>
                    ...
                    <td class="borderTD">&nbsp;</td>
                    <td class="borderTD">&nbsp;</td>
                    <td align="right" class="borderTD_detail">
                      <xsl:choose>
              ...
              <tr>
                <td colspan="2" align="left" class="borderTD_detail">
                  Thuế suất GTGT <i>(VAT rate): </i>
                  <xsl:choose>
              ...
              <tr>
                ...
                <td align="right" class="borderTD_detail">
                  <xsl:choose>
                    <xsl:when test="(inv:invoiceData/inv:totalAmountWithVATFrn) and (inv:invoiceData/inv:totalAmountWithVATFrn)!=''"><xsl:value-of select="format-number(inv:invoiceData/inv:totalAmountWithVATFrn, '#,##0.00', 'usd')"/></xsl:when>
                    <xsl:otherwise>&nbsp;</xsl:otherwise>
                  </xsl:choose>
                </td>
              </tr>
            ...
            <table cellspacing="0" cellpadding="2" style="table-layout:fixed;">
              ...
              <xsl:choose>
                <xsl:when test="not(/inv:invoice/inv:invoiceData/inv:currencyCode) or (/inv:invoice/inv:invoiceData/inv:currencyCode)='' or translate(/inv:invoice/inv:invoiceData/inv:currencyCode,$lower,$upper)='VND' or translate(/inv:invoice/inv:invoiceData/inv:currencyCode,$lower,$upper)='VNĐ'">
                  ...
                  <tr>
                    <td align="center" class="borderTD_detail">
                      <xsl:choose>
                        <xsl:when test="(inv:lineNumber) and (inv:lineNumber)!='' and (inv:lineNumber)!=0"><xsl:value-of select="format-number(inv:lineNumber, '#.##0,##', 'vndong')"/></xsl:when>
                        <xsl:otherwise>&nbsp;</xsl:otherwise>
                      </xsl:choose>
                    </td>
                    <td align="left" class="borderTD">
                ...
                <xsl:otherwise>
                  ...
                  <tr>
                    <td align="center" class="borderTD_detail">
                      <xsl:choose>
                        <xsl:when test="(inv:lineNumber) and (inv:lineNumber)!='' and (inv:lineNumber)!=0"><xsl:value-of select="format-number(inv:lineNumber, '#,##0.00', 'usd')"/></xsl:when>
                        <xsl:otherwise>&nbsp;</xsl:otherwise>
                      </xsl:choose>
                    </td>
                    <td align="left" class="borderTD">
                    ...
                    <td align="right" class="borderTD_detail">
                      <xsl:choose>
                        <xsl:when test="(inv:quantity) and (inv:quantity)!='' and (inv:quantity)!=0"><xsl:value-of select="format-number(inv:quantity, '#,##0.##', 'usd')"/></xsl:when>
                        <xsl:otherwise>&nbsp;</xsl:otherwise>
                      </xsl:choose>
                    </td>
                    <td align="right" class="borderTD_detail">
  ...
  <xsl:variable name="TTNguoiBan">
    <table style="table-layout:auto;">
      ...
      <col width="40%" />
      <tr>
        <td rowspan="7" align="left" valign="middle" style="max-width:200px; max-height:150px; white-space:nowrap; padding-right:7px;">
          <xsl:choose>
        ...
        <td colspan="2" align="left" valign="middle">
          <span style="font-size:12pt;"><b><xsl:value-of select="translate(/inv:invoice/inv:invoiceData/inv:sellerLegalName,$lower,$upper)"/><br />
          <i><xsl:value-of select="translate(/inv:invoice/inv:invoiceData/inv:userDefines/inv:TenNuocNgoai,$lower,$upper)"/></i></b></span>
        </td>
      </tr>
      <tr>        
        <td colspan="2" align="left" valign="top">
          Mã số thuế <i>(Tax code)</i>: <span style="font-size:11pt;"><b><xsl:value-of select="/inv:invoice/inv:invoiceData/inv:sellerTaxCode"/></b></span>
        </td>
      </tr>
      <tr>
        <td colspan="2" align="left" valign="middle">
      ...
      <tr>
        <td align="left" valign="top">
          Điện thoại <i>(Tel.)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:sellerPhoneNumber"/>
        </td>
        <td align="left" valign="top">
          Fax: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:sellerFaxNumber"/>
        </td>
      ...
      <tr>
        ...
        <td align="left" valign="top">
        	Website: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:userDefines/inv:Website"/>
        </td>
      </tr>
      <tr>
        <td colspan="2" align="left" valign="top">Số tài khoản <i>(Account No.)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:sellerBankAccount"/></td>
      </tr>
      <tr>
        <td colspan="2" align="left" valign="top">Tại ngân hàng <i>(At)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:sellerBankName"/></td>
      </tr>
    </table>
  </xsl:variable>
  ...
  <xsl:variable name="TTXacThucvaTTGiaoDich">
    <table>
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          <tr>
            <td colspan="4" align="left" valign="top">Mã nhận hóa đơn <i>(Invoice ID)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:userDefines/inv:MaNhanHoaDon"/></td>
          </tr>
        </xsl:otherwise>
      </xsl:choose>
      <tr>
        <td colspan="4" align="left" valign="top">Địa điểm bán hàng <i>(Point of Sale)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:userDefines/inv:TenChiNhanh"/></td>
      </tr>
      <tr>
        <td colspan="4" align="left" valign="top">Địa chỉ <i>(Address)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:userDefines/inv:DiaChiChiNhanh"/></td>
      </tr>
      <tr>
  ...
  <xsl:variable name="BangKe">
    <table>
      ...
      <tr>
        <td colspan="3" align="left" valign="middle"><b><i><xsl:value-of select="translate(/inv:invoice/inv:invoiceData/inv:userDefines/inv:TenNuocNgoai,$lower,$upper)"/></i></b></td>
      </tr>
      <tr>
    ...
    <table cellspacing="0" cellpadding="2" style="table-layout:fixed;">
      ...
      <xsl:choose>
        <xsl:when test="not(/inv:invoice/inv:invoiceData/inv:currencyCode) or (/inv:invoice/inv:invoiceData/inv:currencyCode)='' or translate(/inv:invoice/inv:invoiceData/inv:currencyCode,$lower,$upper)='VND' or translate(/inv:invoice/inv:invoiceData/inv:currencyCode,$lower,$upper)='VNĐ'">
          ...
          <tr>
            <td colspan="6" align="center" class="borderTD"><b>
              Cộng tiền hàng <i>(Sub total):</i>
            </b></td>
            <td align="right" class="borderTD_detail"><b>
              <xsl:choose>
                <xsl:when test="(/inv:invoice/inv:invoiceData/inv:totalAmountWithoutVAT) and (/inv:invoice/inv:invoiceData/inv:totalAmountWithoutVAT)!=''"><xsl:value-of select="format-number(/inv:invoice/inv:invoiceData/inv:totalAmountWithoutVAT, '#.##0,##', 'vndong')"/></xsl:when>
                <xsl:otherwise>&nbsp;</xsl:otherwise>
              </xsl:choose>
           </b> </td>
          </tr>
        ...
        <xsl:otherwise>
          ...
          <tr>
            ...
            <td align="center" class="borderTD_detail">
              <xsl:choose>
                <xsl:when test="(inv:vatPercentage) and (inv:vatPercentage)!='' and (inv:vatPercentage)!=-1 and (inv:vatPercentage)!=-2"><xsl:value-of select="format-number(inv:vatPercentage, '#,##0.###', 'usd')"/></xsl:when>
                <xsl:when test="(inv:vatPercentage) and (inv:vatPercentage)=0">0</xsl:when>
                <xsl:otherwise>&nbsp;</xsl:otherwise>
              </xsl:choose>
            </td>
          ...
          <tr>
            ...
            <td align="right" class="borderTD_detail"><b>
              <xsl:choose>
                <xsl:when test="(/inv:invoice/inv:invoiceData/inv:totalAmountWithoutVAT) and (/inv:invoice/inv:invoiceData/inv:totalAmountWithoutVAT)!=''"><xsl:value-of select="format-number(/inv:invoice/inv:invoiceData/inv:totalAmountWithoutVAT, '#,##0.00', 'usd')"/></xsl:when>
                <xsl:otherwise>&nbsp;</xsl:otherwise>
              </xsl:choose>
           </b> </td>
          </tr>
