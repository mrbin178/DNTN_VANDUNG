<?xml version="1.0" encoding="utf-8"?><!-- DWXMLSource="HDDT_GTGT_TS24_M3.xml" -->
          ...
          <xsl:when test="(inv:invoiceData/inv:invoiceNumber) and (inv:invoiceData/inv:invoiceNumber)='0000000'">
            <table cellspacing="0" cellpadding="2" style="color:BLACK; table-layout:fixed;">
              ...
              <tr>
                ...
                <td colspan="2" align="center" class="borderTD">(2)</td>
                <td colspan="2" align="center" class="borderTD">(3)</td>
              ...
              <tr><td class="borderTD">&nbsp;</td><td colspan="2" class="borderTD">&nbsp;</td><td colspan="2" class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td></tr>
              <tr><td class="borderTD">&nbsp;</td><td colspan="2" class="borderTD">&nbsp;</td><td colspan="2" class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td></tr>
              <tr><td class="borderTD">&nbsp;</td><td colspan="2" class="borderTD">&nbsp;</td><td colspan="2" class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td></tr>
              <tr><td class="borderTD">&nbsp;</td><td colspan="2" class="borderTD">&nbsp;</td><td colspan="2" class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td></tr>
              <tr><td class="borderTD">&nbsp;</td><td colspan="2" class="borderTD">&nbsp;</td><td colspan="2" class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td><td class="borderTD">&nbsp;</td></tr>
              ...
              <tr>
                <td align="left" colspan="2" class="borderTD">
                  Tiền hàng hóa, dịch vụ<br />
                  <i>(Amount)</i>
                </td>
              ...
              <tr>
                <td align="left" colspan="2" class="borderTD">Tiền thuế <i>(VAT)</i></td>
                <td colspan="2" align="right" class="borderTD">&nbsp;</td>
                <td colspan="2" align="right" class="borderTD">&nbsp;</td>
                <td colspan="2" align="right" class="borderTD">&nbsp;</td>
                <td align="right" class="borderTD">&nbsp;</td>
  ...
  <xsl:variable name="TTXacThucvaTTGiaoDich">
    <table>
      ...
      <tr>
        ...
        <td colspan="2" align="left" valign="top">Email: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:sellerEmail"/></td>
      </tr>
      <tr>
        <td align="left" valign="top" style="border-bottom:1px solid #000">Số tài khoản <i>(Account No.)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:sellerBankAccount"/></td>
        <td colspan="3" align="left" valign="top" style="border-bottom:1px solid #000">Tại ngân hàng <i>(At)</i>: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:sellerBankName"/></td>
      </tr>
      <xsl:choose>
      ...
      <tr>
        <td align="left" valign="top">MST (Tax code): <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:buyerTaxCode"/></td>
        <td align="left" valign="top">Tel: <xsl:value-of select="/inv:invoice/inv:invoiceData/inv:buyerPhoneNumber"/></td>
